 ...
 */
  ...
  #define WATCH_TEMP_INCREASE 4               // Degrees Celsius NL 6/3/23
#endif
 ...
 */
#define E0_AUTO_FAN_PIN PC7 //NL 6/3/23
 ...
 */
#define INPUT_SHAPING_X //NL 6/3/23 allowed input chaping
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu NL 23/3/23
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -1.0 //NL 23/3/23

    // Set a convenient position to do the calibration (probing point and nozzle/bed-distance)
    #define PROBE_OFFSET_WIZARD_XY_POS { X_CENTER, 10 } //NL 23/3/23
  #endif
#endif
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps NL 22/3/23
  #define BABYSTEP_MULTIPLICATOR_Z  0.01       // (steps or mm) Steps or millimeter distance for each Z babystep NL 22/3/23
  #define BABYSTEP_MULTIPLICATOR_XY 0.01       // (steps or mm) Steps or millimeter distance for each XY babystep NL 22/3/23
